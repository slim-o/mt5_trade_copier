...
slave_accounts = [[51647342, 'QJ&@5$qsE3Iht!', 'ICMarketsSC-Demo', 'C:/Program Files/MetaTrader 5 IC Markets (SC)/terminal64.exe', 1], [51605630, 'C5zO4tvq^4', 'ICMarketsSC-Demo', 'C:/Program Files/MetaTrader 5 IC Markets (SC)/terminal64.exe', 1], [1087456, '!N*2aj02', 'VantageInternational-Demo', 'C:/Program Files/Vantage International MT5/terminal64.exe', 0.5]]
...
pair_mapping_table.add_pair_mapping('VantageInternational-Demo', 'EURUSD', 'EURUSD')
pair_mapping_table.add_pair_mapping('VantageInternational-Demo', 'XAUUSD', 'XAUUSD+')
pair_mapping_table.add_pair_mapping('VantageInternational-Demo', 'US30', 'DJ30')
pair_mapping_table.add_pair_mapping('VantageInternational-Demo', 'BTCUSD', 'BTCUSD')
